  ...
  Widget getListRow(String name, String value) {
    return Row(
      ...
      children: [
        ...
        Flexible(child: SelectableText(value, contextMenuBuilder: defaultContextMenuBuilder)),
...
Widget defaultContextMenuBuilder(BuildContext context, EditableTextState editableTextState) {
